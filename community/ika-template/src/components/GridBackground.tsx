/**
 * Full-page decorative grid using the Solana brand colors (purple on the left,
 * green on the right). This is the ONLY place Solana colors appear. The UI
 * itself stays neutral. Purely decorative: fixed, behind everything, no pointer
 * events.
 */
export function GridBackground() {
  return (
    <div className="pointer-events-none fixed inset-0 z-0" aria-hidden="true">
      {/* Ambient glow (most visible in dark mode) */}
      <div
