...
A production-ready Rust server built with **Rocket** for HTTP APIs with x402 payment integration on Solana.

## Features

- **Rocket Framework** - Easy-to-use, type-safe web framework
