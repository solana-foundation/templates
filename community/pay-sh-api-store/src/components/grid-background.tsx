  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0" aria-hidden="true">
      <div
        ...
        style={{
          background: [
            'radial-gradient(ellipse 40% 30% at 30% 50%, rgba(153,69,255,0.06) 0%, transparent 70%)',
            'radial-gradient(ellipse 40% 30% at 70% 50%, rgba(20,241,149,0.06) 0%, transparent 70%)',
          ].join(', '),
        }}
      />
