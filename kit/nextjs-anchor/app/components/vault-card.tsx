      ...
      <div className="rounded-xl border border-border-low bg-cream/30 p-4">
        ...
        {vaultAddress && (vaultLamports ?? 0n) > 0n && (
          <p className="group mt-2 flex items-center gap-1.5">
            ...
            <span className="relative cursor-default text-muted" title="This is your vault PDA — a program-derived account that holds your deposited SOL. Only you can withdraw from it.">
