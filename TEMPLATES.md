...
> Next.js template with Privy authentication, social logins, and embedded Solana wallets

`privy` `authentication` `social-login` `embedded-wallet` `nextjs` `react` `typescript` `tailwind`
